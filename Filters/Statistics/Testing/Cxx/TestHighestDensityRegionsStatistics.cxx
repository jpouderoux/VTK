...
int TestHighestDensityRegionsStatistics(int , char * [])
{
  ...
  vtkNew<vtkIntArray> arrTime;
  arrTime->SetName("t");
  table->AddColumn(arrTime.GetPointer());
  ...
  hdrs->AddColumnPair(namev2, namev1);
  ...
  cout << "\n## Derive results:\n";
  vtkTable* outputMetaDerive = vtkTable::SafeDownCast(outputMetaDS->GetBlock(1));
  outputMetaDerive->Dump();
